    ...
    m_editor(0)
{
    ...
    if (QApplication::isLeftToRight()) {
        m_acAlignLeft = new QAction(QIcon(rsrcPath + "/text_align_right.png"),
                                    tr("&Left"), grp);
        m_acAlignCenter = new QAction(QIcon(rsrcPath + "/text_align_center.png"), tr("C&enter"), grp);
        m_acAlignRight = new QAction(QIcon(rsrcPath + "/text_align_left.png"), tr("&Right"), grp);
    } else {
    ...
    m_cmbSize->addItem(QString("4"));
    m_cmbSize->addItem(QString("5"));
